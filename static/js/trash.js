    ...
    for (let i = 0; i < cardsData.length; i++){
        ...
        if (parseInt(quantity) > 0){
            ...
            <div class="card" data-product-id=${cardsData[i].id}>
                ...
                <button id="remove" class="rate" style="background : transparent; 
                width: 40px; height: 40px; display: flex; align-items: center; 
                border: none;"><img src="/other/free-icon-recycle-bin-3156999 (1).png" 
                style="background : transparent; width: 100%"></p></button>
            </div>`)
        }
